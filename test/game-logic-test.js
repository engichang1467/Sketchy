...
// describe("Test if it will add and record points for guesser(s) based on how fast they have guessed the word", function(done){

// 	it("User will receive word ", function(done){
